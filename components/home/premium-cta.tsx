...
const benefits = ['All notes & PYQs unlocked','Unlimited downloads','Lab manuals & assignments','Priority support','No ads']
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border-t">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-muted-foreground text-lg mb-8">Get full access to all study materials for just ₹299/year</p>
        ...
        <Link href="/premium"><Button size="lg" variant="premium" className="gap-2 text-base px-8">Get Premium — ₹299/year<ArrowRight className="h-5 w-5" /></Button></Link>
      </div>
    </section>
  )
}
