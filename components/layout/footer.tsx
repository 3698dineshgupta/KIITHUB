    ...
    <footer className="border-t bg-background/95 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          {[
            { title: 'Resources', links: [{ href:'/notes', label:'Notes' },{ href:'/pyq', label:'PYQs' },{ href:'/calculator', label:'SGPA/CGPA' },{ href:'/premium', label:'Premium' },{ href:'/requests', label:'Request Hub' },{ href:'/upload-earn', label:'Upload & Earn Premium' }] },
